...
get_ipython().run_cell_magic('time', '', 'model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler)')
...
get_ipython().run_cell_magic('time', '', 'model_conv = train_model(model_conv, criterion, optimizer_conv,\n                         exp_lr_scheduler, num_epochs=25)')
